...
export default function HeroSection() {
  ...
  return (
    <section className="px-4 py-8 lg:px-8 lg:py-12">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[32px] bg-slate-950 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="flex flex-col justify-center px-7 py-14 sm:px-12 lg:px-16 lg:py-20">
          <span className="mb-5 w-fit rounded-full bg-orange-500/15 px-4 py-2 text-sm font-bold text-orange-400">
            {t.badge}
          </span>
          ...
          <div className="mt-8 flex flex-wrap gap-5 text-sm text-slate-300">
            <span className="flex items-center gap-2">
              <Check size={17} className="text-orange-400" />
              {t.fastDelivery}
            </span>
        ...
        <div className="relative flex min-h-[420px] items-center justify-center overflow-hidden bg-orange-500 p-8 sm:p-12">
          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="mt-5 rounded-2xl bg-slate-950 px-5 py-4 text-white shadow-xl">
