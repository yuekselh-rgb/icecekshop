    ...
    popup.document.write(`
      ...
      <html lang="tr">
        ...
        <body>
          ...
          <div class="header">
            <div>
              <div class="label">${language === "de" ? "Kunde" : "Müşteri"}</div>
            ...
            <div>
              <div class="label">${language === "de" ? "Datum" : "Tarih"}</div>
              <div class="value">
          ...
          <h2>${language === "de" ? "Bestellte Produkte" : "Sipariş Ürünleri"}</h2>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="right">${language === "de" ? "Betrag" : "Tutar"}</th>
              </tr>
            </thead>
          ...
          ${
            pfandReturn && pfandReturn.items.length > 0
              ? `
                <div class="pfand">
                  <strong>${language === "de" ? "Pfandrückgabe" : "Pfand İadesi"}</strong>

                  <table>
                    <thead>
                      <tr>
                        <th>${language === "de" ? "Pfandart" : "Pfand Türü"}</th>
                        <th>${language === "de" ? "Menge" : "Adet"}</th>
                        <th class="right">${language === "de" ? "Betrag" : "Tutar"}</th>
                      </tr>
                    </thead>
          ...
          <div class="totals">
            ...
            <div class="row total">
              <span>${language === "de" ? "Vom Kunden zu kassieren" : "Müşteriden Alınacak"}</span>
